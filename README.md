# kde.feveal.weather (2.1) updated for Kubuntu 26.04
...
(Version 2) New Version for Plasma 6 (Kubuntu 25.10)
(Version 2.1) Updated for Kubuntu 26.04

## Authors and acknowledgment:
Fernando Velez (feveal@hotmail.com). Special thanks to Zren (zrenfire@gmail.com), Tully Turk, Kate Buckley, Martin Kotelnik (tully.turk@proton.me).
